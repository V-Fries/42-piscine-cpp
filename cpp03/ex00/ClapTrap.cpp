...
ClapTrap::ClapTrap():
	...
	_energyPoints(10),
	_attackDamage(0) {
	std::cerr << this->_name << " was created by default constructor" << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap& clapTrap):
	...
	std::cerr << this->_name << " was created by copy constructor" << std::endl;
}
...
ClapTrap::ClapTrap(const std::string& name):
	...
	_energyPoints(10),
	_attackDamage(0) {
	std::cerr << this->_name << " was created by std::string name constructor" << std::endl;
}


ClapTrap::~ClapTrap() {
	std::cerr << this->_name << " destructor was called" << std::endl;
}


ClapTrap&	ClapTrap::operator=(const ClapTrap& right) {
	std::cerr << this->_name << " assignment operator was called, it will be overwriten by "
...
void		ClapTrap::attack(const std::string& target) {
	if (this->_hitPoints == 0) {
		std::cout << this->_name << " can't attack as it is out of health\n"
				  << target << " was not attacked" << std::endl;
		return;
	}
	if (this->_energyPoints == 0) {
		std::cout << this->_name << " can't attack as it is out of energy points\n"
				  << target << " was not attacked" << std::endl;
		return;
	}
...
void		ClapTrap::takeDamage(unsigned int amount) {
	if (this->_hitPoints == 0) {
		std::cout << this->_name << " can't take domage as it is out of health" << std::endl;
		return;
	}
